...
class bdHandler():
    ...
    def createTable(self):
        ...
        try:
            ...
            # remover ');' de sql_str += f'{n} REAL,'
            sql_str = sql_str[:-1] 
            sql_str += ');'
            self._lock.acquire()
            # self._cursor.execute(sql_str) para add no banco
            ...
            # print("Erro: ", e.args)
            Snackbar(text=f"Erro createTable:{e.args}", bg_color=(1,0,0,1)).open()
    ...
    def insertData(self, data):
        ...
        try:
            ...
            # sql_str é a string de execuçao do sql
            ...
            # print("Erro: ",e.args)
            Snackbar(text=f"Erro insertData:{e.args}", bg_color=(1,0,0,1)).open()
    ...
    def selectData(self, cols, init_t, final_t):
        ...
        try:
            ...
            # print("Erro: ",e.args)
            Snackbar(text=f"Erro selectData:{e.args}", bg_color=(1,0,0,1)).open()
